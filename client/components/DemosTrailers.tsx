...
const DemosTrailers: React.FC = () => {
  ...
  if (!user) {
    return (
      <div className="min-h-screen flex items-center justify-center">
        <div className="text-red-400">Please login to use this page</div>
      </div>
    );
  }
  if (error) {
      ...
      <div className="max-w-5xl mx-auto pt-10">
        ...
        <div className="grid gap-10">
          {trailerFiles.length === 0 ? (
            <div className="text-center text-gray-400">please add demos and trailers in the file center to use this page</div>
          ) : (
